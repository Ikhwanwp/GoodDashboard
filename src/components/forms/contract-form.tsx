    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-3xl">
        ...
        <div className="flex-grow overflow-hidden">
            <Tabs defaultValue={contractType || 'pks'} className="w-full h-full flex flex-col">
                ...
                <TabsContent value="pks" className="flex-grow overflow-auto -mx-6">
                  <Form {...pksForm}>
                    <form onSubmit={pksForm.handleSubmit(onPksSubmit)} className="flex flex-col h-full">
                ...
                <TabsContent value="mou" className="flex-grow overflow-auto -mx-6">
                    <Form {...mouForm}>
                        <form onSubmit={mouForm.handleSubmit(onMouSubmit)} className="flex flex-col h-full">
                            <ScrollArea className="flex-grow px-6">
                                <div className="space-y-4 py-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <FormField
